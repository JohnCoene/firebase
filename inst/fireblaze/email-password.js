...
Shiny.addCustomMessageHandler('fireblaze-create-email-password', function(msg) {
  firebase.auth().createUserWithEmailAndPassword(msg.email, msg.password)
    .then(function(result) {
      Shiny.setInputValue(msg.ns + 'fireblaze_' + 'created_email_user', {success: true, response: result});
    }).catch(function(error) {
      Shiny.setInputValue(msg.ns + 'fireblaze_' + 'created_email_user', {success: false, response: error});
    });
});
...
Shiny.addCustomMessageHandler('fireblaze-send-verification-email', function(msg) {
  ...
  user.sendEmailVerification().then(function() {
    Shiny.setInputValue(msg.ns + 'fireblaze_' + 'verification_email_sent', {success: true, response: 'successful'})
  }).catch(function(error) {
    Shiny.setInputValue(msg.ns + 'fireblaze_' + 'verification_email_sent', {success: false, response: error})
  });
});
...
Shiny.addCustomMessageHandler('fireblaze-reset-email', function(msg) {
  ...
  firebase.auth().sendPasswordResetEmail(msg.email)
    .then(function() {
      Shiny.setInputValue(msg.ns + 'fireblaze_' + 'reset_email_sent', {success: true, response: 'successful'})
    }).catch(function(error) {
      Shiny.setInputValue(msg.ns + 'fireblaze_' + 'reset_email_sent', {success: false, response: error})
    });
});
...
Shiny.addCustomMessageHandler('fireblaze-re-authenticate', function(msg) {
  ...
  user.reauthenticateWithCredential(credential)
    .then(function() {
      Shiny.setInputValue(msg.ns + 'fireblaze_' + 're_authenticate', {success: true, response: 'successful'});
    }).catch(function(error) {
      Shiny.setInputValue(msg.ns + 'fireblaze_' + 're_authenticate', {success: false, response: error});
    });
});
...
Shiny.addCustomMessageHandler('fireblaze-set-password', function(msg) {
  ...
  user.updatePassword(msg.password)
    .then(function() {
      Shiny.setInputValue(msg.ns + 'fireblaze_' + 'set_password', {success: true, response: 'successful'});
    }).catch(function(error) {
      Shiny.setInputValue(msg.ns + 'fireblaze_' + 'set_password', {success: false, response: error});
    });
});