...
Once setup in the Firebase console you can use those social services in your shiny app. Let's create a basic shiny app that prompts the user to login on load; we'll provide . Remember to import the dependencies in the UI with `use_fireblaze`.
...
We are then going to initialise the authentication from the `FireblazeSocial` object.
