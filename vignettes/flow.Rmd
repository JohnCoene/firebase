...
<h4>Important</h4>
<p style="color:white;">This method is convenient but not secure use the "server" method instead.</p>
</div>
...
<h4>Important</h4>
<p style="color:white;">You are strongly advised to use this method.</p>
</div>
