...
To demonstrate we will build an application that allows users to sign-up/sign-in. The very thing we do is place `use_fireblaze` in the Shiny UI, making sure to set the argument `ui` to `TRUE`. This imports the necessary dependencies., without it nothing will work.
...
ui <- fluidPage(
  use_fireblaze(), # import dependencies
  fireblaze_signin_ui(),
  reqSignin(
    h4("VIP plot below"),
    plotOutput("plot")
