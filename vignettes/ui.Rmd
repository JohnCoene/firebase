...
To demonstrate we will build an application that allows users to sign-up/sign-in. The very thing we do is place `useFirebase` in the Shiny UI, making sure you also place `firebaseUIContainer` in there. This imports the necessary dependencies., without it nothing will work.
